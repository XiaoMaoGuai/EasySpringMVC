...
/*
 * @Description :
 * @FileName: XmgArrayUtils.java
 * @Author :WeiHui.Zhang
 * @Data : 2014年11月9日 下午2:03:36
 * @Version:1.0.0
 */
public abstract class XmgArrayUtils extends org.apache.commons.lang.ArrayUtils {
	...
	/**
	 * <p>
	 * Produces a new <code>String</code> array containing the elements between
	 ...
	 *         indices.
	 */
	public static String[] subarray(String[] array, int startIndexInclusive,
